...
if __name__ == "__main__":
    ...
    NR = [[1.0], [1.0]] * len(wl_list)  # [nr_imp],
    NI = [[0.0], [0.0]] * len(wl_list)  # [ni_imp],
    R1 = 0.0
    R2 = 10.0
    NSD = [6, 6]
    alt_list = [0.0, (1.0 - dep_t), 1.0, 2000., 4000., 6000., 10000., 100000.]
    DELP = alt.altToPressure(alt_list)
...
#             207.17752947768372, 265.00435142957934, 0.000606]
    ...
    for icase in range(start_index, end_index):
        ...
        ## Input variables are in the order:
        ## 'ar_1', 'd_1', 'f_1', 'Reff_1', 'ar_2', 'd_2', 'f_2', 'Reff_2', 'thick_top', 'dens_top', 'dens_bottom'
        ...
        thick_top = df.thick_top.values[0]
        dens_top = df.dens_top.values[0]
        dens_bottom = df.dens_bottom.values[0]
...
#                                               dep_1)
        ...
        thick_bottom = 1 - thick_top
        tau_snow_bottom = scat.calcTau(snow_iop_ref_2_name, dens_bottom, thick_bottom)
        tau_snow_top = scat.calcTau(snow_iop_ref_1_name, dens_top, thick_top)

        # PACKAGING REFERENCE VARIABLES INTO ARRAY OF SPECIES AMOUNTS FOR EACH PRESSURE LAYER
        # [tau_soot_2, tau_soot_1, aod, 0.00E-02, 0.00E-01, 0.00E-01, 0.00E-02, 0.00E-01],

        NZITEMS = [[tau_snow_bottom, 0.00E-01, 0.00E-01, 0.00E-02, 0.00E-01, 0.00E-01, 0.00E-02, 0.00E-01],
